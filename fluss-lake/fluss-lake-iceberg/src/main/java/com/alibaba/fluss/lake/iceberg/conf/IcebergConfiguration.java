...
public class IcebergConfiguration implements Serializable {
    ...
    private IcebergConfiguration(Configuration flussConfig) {
        this.conf = loadHadoopConfig(flussConfig);
    }

    public static IcebergConfiguration from(Configuration flussConfig) {
        return new IcebergConfiguration(flussConfig);
    }
    ...
    private void readObject(ObjectInputStream in) throws ClassNotFoundException, IOException {
        ...
        boolean configIsNull = in.readBoolean();
        if (configIsNull) {
            conf = null;
        } else {
    ...
    private Object loadHadoopConfig(Configuration flussConfig) {
        Class<?> configClass =
                DynClasses.builder()
