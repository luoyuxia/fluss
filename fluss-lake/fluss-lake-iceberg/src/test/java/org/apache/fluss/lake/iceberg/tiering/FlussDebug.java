...
public class FlussDebug {
    ...
    void t1() throws Exception {
        ...
        String tableName = "dv_tiering_table1";

        String bootstrapServers = "127.0.0.1:52460";
        String catalogName = "fluss";
        ...
        batchTEnv.executeSql(
                String.format(
                        ...
                        catalogName, BOOTSTRAP_SERVERS.key(), bootstrapServers));
        batchTEnv.executeSql("use catalog " + catalogName);
        batchTEnv.executeSql("use " + defaultDb);
        ...
        System.out.println(unionReadResults);
    }
}
