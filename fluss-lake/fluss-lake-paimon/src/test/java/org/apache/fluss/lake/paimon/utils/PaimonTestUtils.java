 ...
 *
 * <p>This class provides common methods for creating DV tables, writing data, and triggering
...
public class PaimonTestUtils {
    ...
    public static long writeAndCommitData(
        ...
        FileStoreTable writeTable =
                fileStoreTable.copy(Collections.singletonMap(CoreOptions.WRITE_ONLY.key(), "true"));
