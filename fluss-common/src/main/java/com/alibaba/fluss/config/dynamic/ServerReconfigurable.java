...
public interface ServerReconfigurable {
    ...
    /** Returns the names and name-prefixes of configs that may be reconfigured. */
    ...
    class AllowedConfigs {
        ...
        /**
         * Configuration key prefixes. Keys starting with any of these prefixes can be reconfigured.
         */
        private final Set<String> configKeyPrefixes;

        public AllowedConfigs(Set<String> exactConfigKeys, Set<String> configKeyPrefixes) {
            this.exactConfigKeys = exactConfigKeys;
            this.configKeyPrefixes = configKeyPrefixes;
        }

        public Set<String> getExactConfigKeys() {
            return exactConfigKeys;
        }

        public Set<String> getConfigKeyPrefixes() {
