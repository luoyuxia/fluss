...
import com.alibaba.fluss.flink.tiering.committer.CommittableTypeInfo;
import com.alibaba.fluss.flink.tiering.committer.LakeTieringCommitOperatorFactory;
...
/** The entrypoint for Fluss to tier data to lake. */
public class LakeTieringBuilder {
    ...
    public void build() {
        ...
        source.transform(
                        "committer",
                        CommittableTypeInfo.of(() -> lakeTieringFactory.getCommitableSerializer()),
                        new LakeTieringCommitOperatorFactory(
                                flussConfig,
                                tieringSource,
                                WatermarkStrategy.noWatermarks(),
                                lakeTieringFactory))
