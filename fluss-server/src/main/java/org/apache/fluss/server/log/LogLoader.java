...
final class LogLoader {
            ...
            while (unflushedIter.hasNext() && !truncated) {
                ...
                try {
                    ...
                    if (e instanceof InvalidOffsetException) {
                        ...
                        LOG.warn(
                                "Found invalid offset during recovery. Deleting the corrupt segment "
                ...
                if (truncatedBytes > 0) {
                    ...
                    LOG.warn(
                            "Corruption found in segment {}, truncating to offset {}",
                            segment.getBaseOffset(),
    ...
    private void removeAndDeleteSegments(Iterator<LogSegment> segmentsToDelete) {
        if (segmentsToDelete.hasNext()) {
            ...
            LOG.info(
                    "Deleting segments as part of log recovery: {}",
