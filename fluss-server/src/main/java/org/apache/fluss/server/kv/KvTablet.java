...
public final class KvTablet {
        ...
        return inWriteLock(
                ...
                () -> {
                    ...
                    try {
                        ...
                        kvStateAccessor.truncateTo(logEndOffsetOfPrevBatch, TruncateReason.ERROR);
                        throw t;
                    } finally {
    ...
    private byte[] getFromState(KvPreWriteBuffer.Key key, KvStateAccessor stateAccessor)
            throws IOException {
        return stateAccessor.lookup(key).value();
    }
