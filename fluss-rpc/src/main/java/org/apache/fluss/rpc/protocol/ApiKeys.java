...
public enum ApiKeys {
    ...
    REPORT_POSITION(1060, 0, 0, PRIVATE),
    GET_LAKE_DV_SNAPSHOT(1061, 0, 0, PRIVATE),
    NOTIFY_DV_READY(1062, 0, 0, PRIVATE),
    NOTIFY_READABLE_SWITCH(1063, 0, 0, PRIVATE),
    GET_DV_FOR_UNION_READ(1064, 0, 0, PUBLIC),
    GET_LOG_DV_SNAPSHOT(1065, 0, 0, PRIVATE);
