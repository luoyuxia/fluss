...
public enum ApiKeys {
    ...
    ADD_SERVER_TAG(1044, 0, 0, PUBLIC),
    REMOVE_SERVER_TAG(1045, 0, 0, PUBLIC),
    REBALANCE(1046, 0, 0, PUBLIC),
    LIST_REBALANCE_PROCESS(1047, 0, 0, PUBLIC),
    CANCEL_REBALANCE(1048, 0, 0, PUBLIC);
